...
* @Description: 湖北11选5 开奖号码统计
* @author A18ccms a18ccms_gmail_com 
* @date 2017年9月5日 上午10:57:32 
*
 */
@Service
public class Hubei11xuan5_DrawCodeStatistics extends _11xuan5DrawCodeStatisticsHelper  implements DrawCodeStatisticsHandler {
	...
	public void setDrawCodeStatistics(Integer lotCode){
		super.setDrawCodeStatistics(QuartzHandlerType.HU_BEI_11_XUAN_5.getCode());
	}	
