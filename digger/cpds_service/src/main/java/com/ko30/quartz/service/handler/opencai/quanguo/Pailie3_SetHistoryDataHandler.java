...
/**
 * 
* @ClassName: Pailie3_SetHistoryDataHandler 
* @Description: 排列3
 ...
 */
@Service
public class Pailie3_SetHistoryDataHandler extends FixedOneIntervalSetLotHitoryData implements OpencaiSetLotHistoryDataHandler {

	/**
	 * 每天 20:30:00 开奖  （20:37:55[开彩网开奖时间]）
	 */
	@Override
	public AppLotHistory handler(AppLotHistory targetLot,TShowApiLotType showApiType) {
		...
		//int currWeekday=cal.get(Calendar.DAY_OF_WEEK) - 1;// 得到开奖的星期
		int currDate=cal.get(Calendar.DAY_OF_YEAR);//得到开奖日期，当年中的天数
		
		// 检查当前时间是否是开奖日期，再检查是否是在开奖时间之后
		String currentOpenTimeStr=CommUtil.formatShortDate(cal.getTime())+" 20:40:55";
		...
		int drawDay=drawCal.get(Calendar.DAY_OF_YEAR);// 得到开奖的星期
