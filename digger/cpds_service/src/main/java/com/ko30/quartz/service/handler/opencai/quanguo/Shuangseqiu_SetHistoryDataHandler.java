...
/**
 * 
* @ClassName: Shuangseqiu_SetHistoryDataHandler 
* @Description: 双色球
 ...
 */
@Service
public class Shuangseqiu_SetHistoryDataHandler extends FixedOneIntervalSetLotHitoryData implements
		OpencaiSetLotHistoryDataHandler {

	/**
	 * 每周二、四、日21:30:00开奖  （21:21:45[开彩网开奖时间]）
	 */
	@Override
	public AppLotHistory handler(AppLotHistory targetLot,TShowApiLotType showApiType) {
		...
		if ((currWeekday == 2 || currWeekday == 4 || currWeekday == 0) &&drawDate <currDate) {
