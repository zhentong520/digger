...
import com.ko30.common.base.entity.search.exception.InvlidSearchOperatorException;
 ...
 * <p>Version: 1.0
 */
public final class Condition implements SearchFilter,java.io.Serializable {
...
//    }
    static Condition newCondition(final String searchProperty, final String operator, final Object value) {
    	return new Condition(searchProperty, operator, value);
    }
