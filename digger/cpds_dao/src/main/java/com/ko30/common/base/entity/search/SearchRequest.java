...
import com.ko30.common.base.entity.search.utils.SearchableConvertUtils;
...
//    }
    public Searchable addSearchFilter(final String searchProperty, final String operator, final Object value) {
    	SearchFilter searchFilter = SearchFilterHelper.newCondition(searchProperty, operator, value);
    	return addSearchFilter(searchFilter);
    }
