...
import com.ko30.common.base.entity.search.annotation.EnableQueryCache;
...
public class RepositoryHelper {
     ...
     *  统一EntityManager fix by zoo
     */

    public RepositoryHelper( EntityManager entityManager,Class<?> entityClass) {
        ...
        boolean enableQueryCache = false; // 默认false
...
//    }
    ...
    public static EntityManager getEntityManager() {
        Assert.notNull(entityManager, "entityManager must null, please see " +
                "[com.zwx.arch.core.common.repository.RepositoryHelper#setEntityManagerFactory]");
    ...
    /**
     * <p>ql条件查询<br/>
     * searchCallback默认实现请参考 {@see com.sinosoft.arch.core.common.repository.callback.DefaultSearchCallback}<br/>
     * <p/>
     * 测试用例请参考：{@see com.sinosoft.arch.core.common.repository.UserRepositoryImplForCustomSearchIT}
     * 和{@see com.sinosoft.arch.core.common.repository.UserRepositoryImplForDefaultSearchIT}
     *
     * @param ql
     ...
     * 具体使用请参考测试用例：{@see com.sinosoft.arch.core.common.repository.UserRepository2ImplIT#testFindAll()}
     *
     * @param ql
     ...
     * 具体使用请参考测试用例：{@see com.sinosoft.arch.core.common.repository.UserRepository2ImplIT#testFindOne()}
     *
     * @param ql
     * @param params
     * @param <M>
     ...
     * 具体使用请参考测试用例：com.sinosoft.arch.core.common.repository.UserRepository2ImplIT#testCountAll()
     *
     * @param ql
     * @param params
     * @return
     ...
     * 具体使用请参考测试用例：{@see com.sinosoft.arch.core.common.repository.UserRepository2ImplIT#testBatchUpdate()}
     *
     * @param ql
     * @param params
     * @return
